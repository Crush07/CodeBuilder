...
public class SqlGeneratorUtils {
    ...
    public static void buildSqlByClass() {
    ...
    private static void sqlConstruction() {
        ...
        String packageName = "src/main/java/com/hysea/hyseaappapi/output/entity/po";
        //生成sql的文件夹
        String filePath = "construct\\vo";
        //项目中实体类的路径
        String prefix = "com.hysea.hyseaappapi.output.entity.po.";
        String className = "";
            ...
            for (Field f : fields) {
                ...
                if("id".equals(f.getName())){
                    if ("java.lang.String".equals(typeName)) {
                        column.append(" \n `" + getStandardFields(f.getName()) + "`" + " " + map.get(typeName)).append(" NOT NULL,");
                    } else {
                        column.append(" \n `" + getStandardFields(f.getName()) + "`" + " " + map.get(typeName)).append(" NOT NULL,");
                    }
                }else{
